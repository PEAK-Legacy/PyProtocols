...
\item A relationship between a protocol, and a protocol that it implies or can
be adapted to.
\end{itemize}
...
complex, since the adapter would need some fairly global knowledge of the
...
While following these rules does require a certain amount of care, most of that
care consists of being more careful to define or describe exactly what it is
you want.  And that benefits both you and anyone who needs to interact with
your code.
