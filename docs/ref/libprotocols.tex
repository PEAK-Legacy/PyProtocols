...
\item[factoryMethod = \var{methodName}] \hfill \\
...
top-level \module{protocols} package.  They are arranged in order of
...
value in the objects' instance dictionary.  This is useful if you will be
