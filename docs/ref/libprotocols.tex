...
And that's our point, actually.  Every kind of framework has two kinds of
design issues: issues specific to the framework's subject area, and issues that
apply to frameworks in general.  The \module{protocols} package can save you a
lot of work dealing with the latter, letting you spend more time on the former.
...
\subsubsection{\module{protocols.interfaces} --- Package Interfaces\label{protocol-interfaces-module}}
...
\module{protocols} package.  None of them are really specific to the package,
