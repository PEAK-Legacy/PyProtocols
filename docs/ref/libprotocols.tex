...
on the Zope X3 Milestone 4 version; it will not work with older releases.  Zope
X3 Milestone 4 requires Python 2.3.2 or better, so even though PyProtocols works
with 2.2.2 and up in general, you will need 2.3.2 to use PyProtocols with Zope X3.
\newpage
