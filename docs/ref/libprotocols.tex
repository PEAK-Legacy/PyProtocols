...
raise \exception{protocols.AdaptationFailure}.
...
invoking \var{factory}, or raising \exception{protocols.AdaptationFailure} as
appropriate.
...
And third, \function{protocols.adapt()} has an optional
...
found, and no \var{default} or \var{factory} was supplied.
\end{excdesc}
