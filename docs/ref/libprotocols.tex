...
a \function{__conform__} method, or else they would not be able to tell
...
as they do not have custom \function{__conform__} methods.  See section
...
to define a \function{__conform__} method for its instances (i.e. classes), and
those instances (classes) want to define a \function{__conform__} method for
\emph{their} instances, the metaclass should wrap its \function{__conform__}
method with \function{metamethod}.  Otherwise, the metaclass'
\function{__conform__} method will be hidden by the class-level
\function{__conform__} defined for the class' instances.
\end{funcdesc}
