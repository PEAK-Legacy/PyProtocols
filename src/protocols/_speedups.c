/* Generated by Pyrex 0.7.2 on Fri Aug 22 18:38:36 2003 */
...
static PyObject *__pyx_f_Protocol__adapt__(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /*else*/ {
    ...
    if (__pyx_1) {
      ...
      __pyx_3 = __Pyx_GetName(__pyx_b, "ob"); if (!__pyx_3) {__pyx_filename = __pyx_f1; __pyx_lineno = 350; goto __pyx_L1;}
      __pyx_4 = PyInt_FromLong(1); if (!__pyx_4) {__pyx_filename = __pyx_f1; __pyx_lineno = 350; goto __pyx_L1;}
      __pyx_5 = PyTuple_New(2); if (!__pyx_5) {__pyx_filename = __pyx_f1; __pyx_lineno = 350; goto __pyx_L1;}
      PyTuple_SET_ITEM(__pyx_5, 0, __pyx_3);
      PyTuple_SET_ITEM(__pyx_5, 1, __pyx_4);
      __pyx_3 = 0;
      __pyx_4 = 0;
      __pyx_3 = PyObject_CallObject(__pyx_2, __pyx_5); if (!__pyx_3) {__pyx_filename = __pyx_f1; __pyx_lineno = 350; goto __pyx_L1;}
      Py_DECREF(__pyx_2); __pyx_2 = 0;
    ...
    /*else*/ {
      ...
      __pyx_4 = __Pyx_GetExcValue(); if (!__pyx_4) {__pyx_filename = __pyx_f1; __pyx_lineno = 355; goto __pyx_L1;}
      Py_DECREF(__pyx_v_err);
      __pyx_v_err = __pyx_4;
      __pyx_4 = 0;
  ...
  __pyx_2 = PyObject_GetAttrString(__pyx_v_self, "_Protocol__adapters"); if (!__pyx_2) {__pyx_filename = __pyx_f1; __pyx_lineno = 370; goto __pyx_L1;}
  __pyx_5 = PyObject_GetAttrString(__pyx_2, "get"); if (!__pyx_5) {__pyx_filename = __pyx_f1; __pyx_lineno = 370; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  ...
  if (__pyx_1) {
    ...
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_1; ++__pyx_v_i) {
      ...
      __pyx_3 = (PyObject *)PyTuple_GET_ITEM(((PyTupleObject (*))__pyx_v_mro),__pyx_v_i);
      Py_INCREF(__pyx_3);
      Py_DECREF(__pyx_v_cls);
      __pyx_v_cls = __pyx_3;
      __pyx_3 = 0;
      ...
      __pyx_2 = PyObject_CallObject(__pyx_v_get, __pyx_4); if (!__pyx_2) {__pyx_filename = __pyx_f1; __pyx_lineno = 376; goto __pyx_L1;}
      Py_DECREF(__pyx_4); __pyx_4 = 0;
      Py_DECREF(__pyx_v_factory);
      ...
      __pyx_6 = __pyx_v_factory != Py_None;
      if (__pyx_6) {

        /* "C:\cygwin\home\pje\PyProtocols\src/protocols/_speedups.pyx":378 */
        __pyx_5 = PyInt_FromLong(0); if (!__pyx_5) {__pyx_filename = __pyx_f1; __pyx_lineno = 378; goto __pyx_L1;}
        __pyx_3 = PyObject_GetItem(__pyx_v_factory, __pyx_5); if (!__pyx_3) {__pyx_filename = __pyx_f1; __pyx_lineno = 378; goto __pyx_L1;}
        Py_DECREF(__pyx_5); __pyx_5 = 0;
        __pyx_4 = PyTuple_New(2); if (!__pyx_4) {__pyx_filename = __pyx_f1; __pyx_lineno = 378; goto __pyx_L1;}
        Py_INCREF(__pyx_v_obj);
        PyTuple_SET_ITEM(__pyx_4, 0, __pyx_v_obj);
        Py_INCREF(__pyx_v_self);
        PyTuple_SET_ITEM(__pyx_4, 1, __pyx_v_self);
        __pyx_2 = PyObject_CallObject(__pyx_3, __pyx_4); if (!__pyx_2) {__pyx_filename = __pyx_f1; __pyx_lineno = 378; goto __pyx_L1;}
        Py_DECREF(__pyx_3); __pyx_3 = 0;
        Py_DECREF(__pyx_4); __pyx_4 = 0;
        __pyx_r = __pyx_2;
        __pyx_2 = 0;
  ...
  __pyx_6 = PyList_Check(__pyx_v_mro);
  if (__pyx_6) {
    ...
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_1; ++__pyx_v_i) {
      ...
      __pyx_5 = (PyObject *)PyList_GET_ITEM(((PyListObject (*))__pyx_v_mro),__pyx_v_i);
      Py_INCREF(__pyx_5);
      Py_DECREF(__pyx_v_cls);
      __pyx_v_cls = __pyx_5;
      __pyx_5 = 0;
      ...
      __pyx_4 = PyObject_CallObject(__pyx_v_get, __pyx_3); if (!__pyx_4) {__pyx_filename = __pyx_f1; __pyx_lineno = 384; goto __pyx_L1;}
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      Py_DECREF(__pyx_v_factory);
      ...
      if (__pyx_6) {
        ...
        __pyx_2 = PyInt_FromLong(0); if (!__pyx_2) {__pyx_filename = __pyx_f1; __pyx_lineno = 386; goto __pyx_L1;}
        __pyx_5 = PyObject_GetItem(__pyx_v_factory, __pyx_2); if (!__pyx_5) {__pyx_filename = __pyx_f1; __pyx_lineno = 386; goto __pyx_L1;}
        Py_DECREF(__pyx_2); __pyx_2 = 0;
        __pyx_3 = PyTuple_New(2); if (!__pyx_3) {__pyx_filename = __pyx_f1; __pyx_lineno = 386; goto __pyx_L1;}
        Py_INCREF(__pyx_v_obj);
        PyTuple_SET_ITEM(__pyx_3, 0, __pyx_v_obj);
        Py_INCREF(__pyx_v_self);
        PyTuple_SET_ITEM(__pyx_3, 1, __pyx_v_self);
        __pyx_4 = PyObject_CallObject(__pyx_5, __pyx_3); if (!__pyx_4) {__pyx_filename = __pyx_f1; __pyx_lineno = 386; goto __pyx_L1;}
        Py_DECREF(__pyx_5); __pyx_5 = 0;
        Py_DECREF(__pyx_3); __pyx_3 = 0;
        __pyx_r = __pyx_4;
        __pyx_4 = 0;
  ...
  /*else*/ {
    ...
    __pyx_2 = PyObject_GetIter(__pyx_v_mro); if (!__pyx_2) {__pyx_filename = __pyx_f1; __pyx_lineno = 391; goto __pyx_L1;}
    for (;;) {
      __pyx_L14:;
      ...
      __pyx_3 = PyTuple_New(1); if (!__pyx_3) {__pyx_filename = __pyx_f1; __pyx_lineno = 392; goto __pyx_L1;}
      Py_INCREF(__pyx_v_cls);
      PyTuple_SET_ITEM(__pyx_3, 0, __pyx_v_cls);
      __pyx_4 = PyObject_CallObject(__pyx_v_get, __pyx_3); if (!__pyx_4) {__pyx_filename = __pyx_f1; __pyx_lineno = 392; goto __pyx_L1;}
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      Py_DECREF(__pyx_v_factory);
      __pyx_v_factory = __pyx_4;
      __pyx_4 = 0;
      ...
      if (__pyx_6) {
        ...
        __pyx_5 = PyInt_FromLong(0); if (!__pyx_5) {__pyx_filename = __pyx_f1; __pyx_lineno = 394; goto __pyx_L1;}
        __pyx_3 = PyObject_GetItem(__pyx_v_factory, __pyx_5); if (!__pyx_3) {__pyx_filename = __pyx_f1; __pyx_lineno = 394; goto __pyx_L1;}
        Py_DECREF(__pyx_5); __pyx_5 = 0;
        ...
        Py_INCREF(__pyx_v_self);
        PyTuple_SET_ITEM(__pyx_4, 1, __pyx_v_self);
        __pyx_5 = PyObject_CallObject(__pyx_3, __pyx_4); if (!__pyx_5) {__pyx_filename = __pyx_f1; __pyx_lineno = 394; goto __pyx_L1;}
        Py_DECREF(__pyx_3); __pyx_3 = 0;
        Py_DECREF(__pyx_4); __pyx_4 = 0;
        __pyx_r = __pyx_5;
        __pyx_5 = 0;
